...
void	sort_sprite(t_data *data, int *index, double *distance_dub)
{
	int i;
	int y;
	int rank;
...
void	cast_sprite(t_data *data)
{
	...
	int spriteOrder[data->sprite.number];
	double spriteDistance[data->sprite.number];
	...
	sort_sprite(data, spriteOrder, spriteDistance);
	i = 0;
	while (i < data->sprite.number)
	{
